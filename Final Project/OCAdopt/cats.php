...
<h2>Cats</h2 >
  ...
  <div align="left">
      <a href="newCat.php" button type="NewCat" class="btn btn-primary">New Cat</a>
      <br>
      <br>
    </div>
  </form>
      ...
      <?php
        ...
        ?>
          <tr>
            ...
            <td>
              <a href="catupdate.php?u_id=<?php echo $row['petID']; ?>" class ="btn btn-info" role="button">Update</a>
              <a href="catdelete.php?u_id=<?php echo $row['petID']; ?>" class ="btn btn-danger" role="button">Delete</a>
            </td>
          </tr>
          <?php
        }
...
<a href="catcsv.php" class ="btn btn-info" role="button">Get Report</a>
</div>
